...
int main(int argc, char *argv[])
{
    ...
    if (argc < 13) {
        printf("audiolisten server-ip server-tcp-port client-udp-port payload-size playback-del gamma buf-sz target-buf logfile-c filename k flag .\n");
        printf("./audiolisten 128.10.3.57 57666 52833 250  2.5 10 4000 1000 logC tmp/pp.au 10 1 \n");
        exit(0);
    }
    ...
    int playbackDel =(int) fplaybackDel*1000000; // 1s = 1000000 usec
